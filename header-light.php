				...
				<header id="header" class="header">
					<div class="top_menu_wrap d-flex">
						<div class="left d-flex">
							<div class="logo"><a href="<?php echo get_home_url(); ?>"><img src="<?php $logo = get_field('logo','options'); echo $logo['url'] ?>" alt=""></a></div>
							<div class="logo dark"><a href="<?php echo get_home_url(); ?>"><img src="<?php $logo = get_field('logo_dark','options'); echo $logo['url'] ?>" alt=""></a></div>
									...
									<div class="item">
										...
										<div class="social-icons d-flex">
											<?php 
												...
												<?php $link = get_field('youtube_link', 'options');?>
												<a class="youtube" href="<?php echo $link;?>"><?php $icon = get_field('youtube_icon', 'options'); echo file_get_contents($icon['url'])?></a>
										</div>
										<a href="#" class="subscribe">Подписка через RSS</a>
									</div>
								</div>
								<div class="bottom">
