	...
	<div class="main">
		<section class="top_section">
			<div class="top d-flex">
				<div class="top_section_left_wrap">
				...
				<div class="main_slider_wrap">
					<div class="main_slider">
						<?php 
						$post_objects = get_field('top_slider');
			...
			<div class="bottom d-flex">
				<div class="top_section_left_slider_wrap">
					<div class="top_section_left_slider">
					<?php 
					$post_objects = get_field('top_slider');
				...
				<div class="main_slider_nav_wrap">
		...
		<div class="latest_posts_wrap">
			<div class="container">
				<h2 class="latest_posts_title">Последнее из блога</h2>
				<div class="latest_posts_list d-flex desktop">
					<?php 
						$args = array(
							'posts_per_page' => 1,
							'orderby' => 'post_date',
				...
				<div class="latest_posts_list_wrap mobile">
					<div class="latest_posts_list for">
						<?php $args = array(
							'posts_per_page' => 3,
							'orderby' => 'post_date',
	    					'order' => 'DESC'
					...
					<div class="latest_posts_list nav">
						<?php $args = array(
							'posts_per_page' => 3,
							'orderby' => 'post_date',
	    					'order' => 'DESC'
				...
				<div class="button_wrap">
					<a href="<?php the_permalink(282) ?>" class="btn">Смотреть больше постов<img src="<?php echo get_field('more_posts_button_bg')['url']?>"></a>
				</div>
			</div>						
		</div>
			...
			<div class="container d-flex">
				<div class="form_wrap_left">
					<div class="section_title">
						<?php the_field('form_section_title')?>
					</div>
					<div class="form_subtitle">
						<?php the_field('form_section_subtitle')?>
					</div>
					<div class="form">						
						<?php 
